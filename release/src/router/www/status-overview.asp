...
/* QRCODE-BEGIN */
			{ title: 'QR code', rid: 'qr-code'+uidx, text: '<a href="tools-qr.asp?wl='+wl_unit(uidx)+(wl_sunit(uidx) >= 0 ? '.'+wl_sunit(uidx) : '')+'"><img src="qr-icon.svg" alt="" style="width:12px;height:12px"><\/a>' },
/* QRCODE-END */
